...
*/
  ...
  if (isset($mynum)) {
    ...
    $rmsg=preg_split("/[\n\r]+/",$para[1],-1,PREG_SPLIT_NO_EMPTY);
    
    $result=array();

    for($i=0;$i <= count($rmsg);$i++) {
      $msgdata=preg_split("/: /",$rmsg[$i],-1,PREG_SPLIT_NO_EMPTY);
      $result[$msgdata[0]]=$msgdata[1];
    }
    ...
    <TABLE CELLPADDING=0 CELLSPACING=0 WIDTH=90%>
      <TR CLASS=list-color2>
        ...
        <TH ALIGN=LEFT>Number To Call</TH>

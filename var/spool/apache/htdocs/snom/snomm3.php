...
%NETWORK_VLAN_ID%:<%print $vlantag . "\n";%>
%NETWORK_VLAN_USER_PRIORITY%:<%print $vlanprio . "\n";%>
...
%NETWORK_SNTP_SERVER%:"<%print $domain;%>"
%NETWORK_SNTP_SERVER_UPDATE_TIME%:255
%AUTOMATIC_SYNC_CLOCK%:1
%GMT_TIME_ZONE%:15
%DST_ENABLE%:0
%SRV_0_SIP_UA_DATA_SERVER_IS_LOCAL%:1
%SUBSCR_0_UA_DATA_DISP_NAME%:"<%print $name;%>"
%SUBSCR_0_SIP_UA_DATA_SIP_NAME%:"<%print $exten;%>"
%SUBSCR_0_UA_DATA_AUTH_PASS%:"<%print $pass;%>"
%SUBSCR_0_SIP_UA_DATA_SIP_NAME_ALIAS%:"<%print $exten;%>"
%SUBSCR_0_SIP_UA_DATA_VOICE_MAILBOX_NAME%:""
%SUBSCR_0_SIP_UA_DATA_VOICE_MAILBOX_NUMBER%:""
%SRV_0_SIP_UA_DATA_DOMAIN%:"<%print $domain;%>"
%SRV_0_SIP_UA_DATA_PROXY_ADDR%:""
%SUBSCR_0_UA_DATA_AUTH_NAME%:"<%print $exten;%>"

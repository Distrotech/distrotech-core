...
<TR CLASS=list-color2>
  <TH CLASS=heading-body COLSPAN=2><%print _("Asterisk PBX Port Forward Configuration");%></TH>
</TR>
<TR CLASS=list-color1>
<TD onmouseover="myHint.show('DA0')" onmouseout="myHint.hide()"><%print _("Select Port Forward To Delete");%></TD>
<TD><SELECT NAME=key>
<OPTION VALUE=""><%print _("Add New DDI Port Forward Below");%></OPTION>
<%
...
<TR CLASS=list-color2>
<TD onmouseover="myHint.show('DA1')" onmouseout="myHint.hide()"><%print _("Port To Forward") . " (I<PORT> = ISDN T<PORT> = TDM)";%></TD>

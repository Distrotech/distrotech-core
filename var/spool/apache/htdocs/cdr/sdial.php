...
%>
  ...
  <TD onmouseover="myHint.show('DA0')" onmouseout="myHint.hide()"><%print _("Select Speed Dial To Delete");%></TD>
  <TD>
  <SELECT NAME=key>
    <OPTION VALUE=""><%print _("Add New Speed Dial Below");%></OPTION><%
  ...
  <TR CLASS=list-color2>
  <TD onmouseover="myHint.show('DA3')" onmouseout="myHint.hide()"><%print _("Discription");%></TD>
  <TD><INPUT TYPE=TEXT NAME=newdiscrip></TD>
  </TR>
  <TR CLASS=list-color1>
    <TD ALIGN=MIDDLE COLSPAN=2>
      <INPUT TYPE=RESET>
      <INPUT TYPE=BUTTON NAME=pbutton VALUE="<%print _("Print");%>" ONCLICK="printpage(document.printform)">

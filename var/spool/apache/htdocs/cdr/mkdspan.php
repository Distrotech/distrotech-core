...
%>
  <TH CLASS=heading-body COLSPAN=2><%print _("Select Dynamic Span To Modify");%></TH>
</TR>
...
<TR CLASS=list-color2>
  <TD ALIGN=LEFT WIDTH=50% onmouseover="myHint.show('Z2')" onmouseout="myHint.hide()"><%print _("Span To Add (INT/MAC/SUB)");%></TH>
  <TD WIDTH=50% ALIGN=LEFT>

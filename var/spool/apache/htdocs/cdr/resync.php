...
%>
<script>
  atapopupwin('<%print $device;%>','<%print $pserver;%>');
</script>
<% 
}
...
<TR CLASS=list-color1><TD onmouseover="myHint.show('LA5')" onmouseout="myHint.hide()">Settings Server</TD><TD><INPUT NAME=pserver VALUE="<%print $SERVER_NAME;%>"></TD></TR>
...
<INPUT TYPE=HIDDEN NAME=ipaddr VALUE="<%print $ipaddr;%>">
<INPUT TYPE=HIDDEN NAME=edelete>
<TR CLASS=list-color2><TH COLSPAN=2 CLASS=heading-body>Editing Linksys ATA (<%print $mac;%>)</TH></TR><TR CLASS=list-color1><TD onmouseover="myHint.show('LA1')" onmouseout="myHint.hide()"
>Device Description</TD><TD><INPUT NAME=ldescrip VALUE="<%print $ldescrip;%>"></TD></TR>
<TR CLASS=list-color2><TD onmouseover="myHint.show('LA4')" onmouseout="myHint.hide()">STUN Server (Optional)</TD><TD><INPUT NAME=stunsrv VALUE="<%print $stunsrv;%>"></TD></TR>
<TR CLASS=list-color1><TD onmouseover="myHint.show('LA5')" onmouseout="myHint.hide()">Settings Server</TD><TD><INPUT NAME=pserver VALUE="<%print $pserver;%>"></TD></TR>

<TR CLASS=list-color2><TD onmouseover="myHint.show('LA6')" onmouseout="myHint.hide()">RX Gain</TD><TD><INPUT NAME=rxgain VALUE="<%print $rxgain;%>"></TD></TR>
<TR CLASS=list-color1><TD onmouseover="myHint.show('LA7')" onmouseout="myHint.hide()">TX Gain</TD><TD><INPUT NAME=txgain VALUE="<%print $txgain;%>"></TD></TR>
<TR CLASS=list-color2><TD onmouseover="myHint.show('LA8')" onmouseout="myHint.hide()">VLAN Id</TD><TD><INPUT NAME=vlanid VALUE="<%print $vlanid;%>"></TD></TR>
...
%>
    <TD><A HREF="javascript:delexten('<%print $cexten;%>','<%print $exten;%>')"><B><%print $cexten;%></B></A></TD>
<%
    if ($ecnt % 2) {
      $rcnt++;

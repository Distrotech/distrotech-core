...
%>
<TH COLSPAN=2 CLASS=heading-body>Editing Provider <%print $prov[1] . " (" . $prov[0] . ")";%></TH></TR>
<TR CLASS=list-color1>
<TD WIDTH=50%>Provider Name</TD><TD><INPUT TYPE=TEXT NAME=pname VALUE="<%print $prov[1];%>"></TD></TR>
<TR CLASS=list-color2>
<TD>Remove Prefix (Local Country Code)</TD><TD><INPUT TYPE=TEXT NAME=removeprefix VALUE="<%print $prov[2];%>"></TD></TR>
<TR CLASS=list-color1>
<TD>National Prefix To Add</TD><TD><INPUT TYPE=TEXT NAME=pnatpre VALUE="<%print $prov[3];%>"></TD></TR>
<TR CLASS=list-color2>
<TD>Min National Length</TD><TD><INPUT TYPE=TEXT NAME=pnatlen VALUE="<%print $prov[5];%>"></TD></TR>
<TR CLASS=list-color1>
<TD>International Prefix</TD><TD><INPUT TYPE=TEXT NAME=pinatpre VALUE="<%print $prov[4];%>"></TD></TR>
<TR CLASS=list-color2>
...
<INPUT TYPE=HIDDEN NAME=trunkprefix VALUE="<%print $prov['0'];%>">
</TD></TR>
</TABLE>
</FORM>
<%
...
%>
  <TH CLASS=heading-body COLSPAN=2><%print _("Select Provider To Modify");%></TH>
</TR>
<TR CLASS=list-color1>
  <TD ALIGN=LEFT WIDTH=50% onmouseover="myHint.show('Z1')" onmouseout="myHint.hide()"><%print _("Provider To Configure");%></TH>
...
<TR CLASS=list-color2>
  <TD ALIGN=LEFT WIDTH=50% onmouseover="myHint.show('Z2')" onmouseout="myHint.hide()"><%print _("Provider To Add");%></TH>
  <TD WIDTH=50% ALIGN=LEFT>
    <INPUT NAME=newprov VALUE="">
  </TD></TR>
<TR CLASS=list-color1>
  <TH COLSPAN=2>
    <INPUT TYPE=SUBMIT NAME=subme onclick=this.name='provupdate' VALUE="<%print _("Add/Modify Provider");%>">
</TH>
</TR>
  </TABLE>
  </FORM>

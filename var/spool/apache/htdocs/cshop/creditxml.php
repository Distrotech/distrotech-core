...
$contq="SELECT name,fullname||' ('||name||') ['||round(credit/10000.00,2)||']' FROM users WHERE usertype > 0 AND agentid='" . $_SESSION['resellerid'] . "' AND (name ~ '" . $_POST['search'] . "' OR fullname ~* '" . $_POST['search'] . "') ORDER BY fullname,name LIMIT 20";
print $contq;

...
<INPUT TYPE=HIDDEN NAME=disppage VALUE="cdr/qagntstat.php">
<INPUT TYPE=HIDDEN NAME=slog VALUE=time>
<TABLE WIDTH=30% CELLPADDING=0 CELLSPACING=0>
<TR><TD><FONT SIZE=1>
<TABLE WIDTH=100% CELLSPACING=0 CELLPADING=0>
<TR CLASS=list-color2>
<TH COLSPAN=3 CLASS=heading-body>Usage Report</TH></TR>
<TR CLASS=list-color1>
<TH COLSPAN=3 CLASS=heading-body2>Usage From</TH></TR>
<TR CLASS=list-color2>

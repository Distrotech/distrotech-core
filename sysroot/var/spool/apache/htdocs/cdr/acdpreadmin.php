...
if (isset($pbxupdate)) {
  if ($newkey != "") {
    pg_query($db,"INSERT INTO astdb (family,key,value) VALUES ('ACDPrefix','$newkey','1')");
  } else if ($key != "") {
    pg_query($db,"DELETE FROM astdb WHERE family='ACDPrefix' AND value='1' AND key='$key'");
  }
}

$qgetdata=pg_query($db,"SELECT key FROM astdb WHERE family='ACDPrefix' AND value='1' ORDER BY key;");
...
<TR CLASS=list-color2>
  <TH CLASS=heading-body COLSPAN=2><?php print _("Asterisk PBX ACD Prefix Configuration");?></TH>
</TR>

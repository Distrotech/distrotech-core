...
<TR CLASS=list-color2>
  <TH CLASS=heading-body COLSPAN=2><?php print _("Open HTML Phone");?></TH>
</TR>
<TR CLASS=list-color1>
<TD WIDTH=50% onmouseover="myHint.show('WP0')" onmouseout="myHint.hide()"><?php print _("Select Phone To Open");?></TD>

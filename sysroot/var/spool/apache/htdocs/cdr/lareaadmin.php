...
<TR CLASS=list-color2>
  <TH CLASS=heading-body COLSPAN=2><%print _("Asterisk PBX Local Area Configuration");%></TH>
</TR>
<TR CLASS=list-color1>
<TD onmouseover="myHint.show('LA0')" onmouseout="myHint.hide()"><%print _("Select Area Code To Delete");%></TD>
<TD><SELECT NAME=key>
<OPTION VALUE=""><%print _("Add New Area Code Bellow");%></OPTION>
<%
...
<TR CLASS=list-color2>
<TD onmouseover="myHint.show('LA1')" onmouseout="myHint.hide()"><%print _("New Area To Be Concidered Local");%></TD>

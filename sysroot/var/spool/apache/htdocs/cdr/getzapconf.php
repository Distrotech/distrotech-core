...
$chans=$agi->command("zap show channels");
...
print "<TR CLASS=list-color2><TH CLASS=heading-body COLSPAN=2>" . _("Zaptel Configuration") . "</TH></TR>\n";
$bcol=0;
$chan=1;
...
if ($bcol == "0") {
  print "<TR CLASS=list-color" . (($bcol %2) + 1). "><TD>This System Has No Zap Interfaces</TD></TR>";
  $bcol++;
}
...
?>
    ...
    <TH COLSPAN=2 CLASS=heading-body><?php print _("Zap Channels");?></TH>
  </TR>

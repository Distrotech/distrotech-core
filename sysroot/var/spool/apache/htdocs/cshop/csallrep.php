...
<INPUT TYPE=HIDDEN NAME=date2 VALUE="<?php print $_POST['date2'];?>">
<INPUT TYPE=HIDDEN NAME=dom VALUE="<?php print $_POST['dom'];?>">
<INPUT TYPE=HIDDEN NAME=dom2 VALUE="<?php print $_POST['dom2'];?>">

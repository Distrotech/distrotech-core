...
<TD WIDTH=50% ALIGN=LEFT><?php print $sesbooth[0];?></TD>
<TR CLASS=list-color2>
<TD ALIGN=LEFT WIDTH=50%>Number</TD>
<TD WIDTH=50% ALIGN=LEFT><?php print $_POST['cno'];?></TD>
<TR CLASS=list-color1>
<TD ALIGN=LEFT WIDTH=50%>Credit Assigned</TD>
<TD WIDTH=50% ALIGN=LEFT><?php printf("R%0.2f",$_SESSION['credit']);?></TD>
<TR CLASS=list-color2>
<TD ALIGN=LEFT WIDTH=50%>Refund</TD>
<TD WIDTH=50% ALIGN=LEFT><?php printf("R%0.2f",$creditin-$_SESSION['credit']);?></TD>
<TR CLASS=list-color1>
<TD ALIGN=LEFT WIDTH=50%>Session ID</TD>
<TD WIDTH=50% ALIGN=LEFT><?php print $_POST['sesname'];?></TD>
</TR>
</TABLE>
<?php
} else {
...
<TR CLASS=list-color1>
  ...
  <TD WIDTH=50% ALIGN=LEFT><SELECT NAME=cno><?php
...
<TR CLASS=list-color1>
  <TD ALIGN=LEFT>Credit To Assign (R)<BR>R<?php printf("%0.2f",$cav[0]);?> Avail.</TD>

...
<TABLE WIDTH=90% CELLPADDING=0 CELLSPACING=0>
  ...
  <tr CLASS=list-color2>
    <TH COLSPAN=2 CLASS=heading-body><?php print _("Modify A Hosted Domain");?></TH>
  </TR>
  <tr CLASS=list-color1>
    <td VALIGN=MIDDLE onmouseover=myHint.show('DNSU1') ONMOUSEOUT=myHint.hide()>
      <?php print _("Hosted Domain To Modify");?>
    </TD>
    <td VALIGN=MIDDLE>
  ...
  <tr CLASS=list-color2>
   ...
   <tr CLASS=list-color1>
     <td colspan=2 valign=middle align=center>
       <INPUT TYPE=BUTTON VALUE="<?php print _("Modify Domain");?>" ONCLICK=opendnsadmin(this.form)>
      </td>
  </tr>
</TABLE>
</FORM>

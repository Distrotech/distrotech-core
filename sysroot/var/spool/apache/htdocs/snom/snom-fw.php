...
} else if ((($sipver[0] == 7) && ($sipver[1] < 3)) || (($sipver[0] == 7) && ($sipver[1] == 3) && ($sipver[2] < 30)) ||
           (($sipver[0] == 6) && ($sipver[1] == 5) && ($sipver[2] == 20))) {
  print "firmware: http://" . $SERVER_NAME . "/snom/snom" . $phone . "-7.3.30-SIP-bf.bin\n";
} else if ((($sipver[0] == 7) || (($sipver[0] == 8) && ($sipver[1] < 4)) || 
           (($sipver[0] == 8) && ($sipver[1] == 4) && ($sipver[2] < 31))) && 
            (is_file("snom-" . $phone . "-8.4.31-SIP-f.bin"))) {

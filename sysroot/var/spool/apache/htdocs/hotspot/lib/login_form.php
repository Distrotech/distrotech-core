...
<? endif; ?>
<tr>
	<td class="form_submit" colspan="2"><input type="submit" name="login" value="<?=_t('login')?>" onclick="popUpWindow('<?=LOGINPATH?>?res=popup1&uamip=<?=$_SESSION['uamip']?>&uamport=<?=$_SESSION['uamport']?>','GLS','410','325',0,0,0,0)"></td>
</tr>
</tbody>
</table>
</center>
